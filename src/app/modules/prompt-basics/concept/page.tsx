...
// Removed unused getMostRecentStep import
...
export default function ConceptScreen() {
  ...
  return (
    <section className="p-6">
      <h1 className="text-2xl font-bold mb-4">What is a Prompt?</h1>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mb-6">
        {/* Animation: search → results (MagicUI/Aceternity UI) */}
        <div className="bg-gradient-to-r from-yellow-100 to-blue-100 rounded-lg p-4 shadow">
          <span className="text-lg">Imagine you type a question into a search box and get an answer. That question is a prompt!</span>
        </div>
      </motion.div>
      <p>
        A prompt is an instruction that creates a result. In AI, prompts guide the model to generate answers.
      </p>
